...
// MiniAudioAudioDevice::MiniAudioAudioDevice(const std::string &userStreamName, const std::string &outputDeviceName, const std::string &inputDeviceName, AudioDevice::Api audioApi, bool splitChannels):
//     AudioDevice(), mUserStreamName(userStreamName), mOutputDeviceName(outputDeviceName), mInputDeviceName(inputDeviceName), mInputInitialized(false), mOutputInitialized(false), mSplitChannels(splitChannels) {
...
//                                                         &devices[i].id, &detailedDeviceInfo);
//                     if (result == MA_SUCCESS) {
//                         LOG("MiniAudioAudioDevice", "Output: ID:%s - %s (Default: %s, Format Count: %d)",
//                             devices[i].id, devices[i].name, detailedDeviceInfo.isDefault ? "Yes" : "No",
//                             detailedDeviceInfo.nativeDataFormatCount);
...
//         ma_result_description(result)); return false;
//     }
...
// std::shared_ptr<AudioDevice> AudioDevice::makeDevice(const std::string &userStreamName, const std::string &outputDeviceId, const std::string &inputDeviceId, AudioDevice::Api audioApi, bool splitChannels) {
